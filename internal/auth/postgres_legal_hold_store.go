...
func (s *PostgresLegalHoldStore) Release(ctx context.Context, id string) error {
	const q = `UPDATE legal_holds SET released = TRUE, released_at = $1 WHERE id = $2 AND released = FALSE`
