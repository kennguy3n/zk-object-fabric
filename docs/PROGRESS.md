...
- [ ] Region-specific compliance (GDPR, HIPAA, FedRAMP, etc). `internal/compliance/audit_trail.go` + `residency_enforcer.go` cover the GDPR-aligned pre-flight; HIPAA / FINRA / SEC are out of Phase 4 scope.
